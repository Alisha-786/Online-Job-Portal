...
<div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto" id="icons">
                    <li class="nav-item"><a class="nav-link" href="EmployerHomePage.jsp">Home</a></li>
        <li class="nav-item"><a class="nav-link" href="EmployerPostJob.jsp">Post aJob</a></li>
        <li class="nav-item"><a class="nav-link" href="#platform-container">About Us</a></li>
        ...
        <li class="nav-item"><a class="nav-link" href="#"> <i class="bi bi-bell"></i></a></li> 
                ...
                <a href="EmployerProfile.jsp" class="nav-link d-flex align-items-center">
	...
	<!--Fourth section-->
	<div class="container py-3" id= 'platform-container'>
